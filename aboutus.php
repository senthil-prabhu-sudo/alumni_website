...
<body>
    <div class="alumnimain">
        ...
        <div class="content">
            Develop a fully connected, strong bannari amman alumni community.<br>
        </div>
        <div class="subheading">
            <b>MISSION</b>
        </div>
        <div class="content">
            Promote alumni relationships, develop student engagement, and allow student-alumni interactions to benefit Bannari Amman Institute of Technology.
